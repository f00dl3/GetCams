...
(
curl --max-time 3 "http://?:88/cgi-bin/CGIProxy.fcgi?cmd=snapPicture2&usr=$ipCamUser&pwd=$ipCamPass" > /dev/shm/GetCams/Xwebc3-temp.jpeg &
curl --max-time 3 "http://?:88/cgi-bin/CGIProxy.fcgi?cmd=snapPicture2&usr=$ipCamUser&pwd=$ipCamPass" > /dev/shm/GetCams/Xwebc2-temp.jpeg
)
